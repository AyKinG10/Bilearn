...
@section('content')
    ...
    <div class="container m-5">
        <div class="row justify-content-center">
            ...
            <div class="col-md-10">
                <a  href="{{ route('adm.questions.index') }}" class="btn btn-outline-primary mb-5">Сұрақтарға өту</a>
                <form action="{{route('adm.questions.store')}}" method="post" enctype="multipart/form-data">
                    @csrf
